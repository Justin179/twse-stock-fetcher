...
# --- Streamlit ---
st.set_page_config(page_title="順勢而為, 主力確認, eps上修", layout="wide")
...
with col2:
    if selected:
        with st.expander("🧮 RSI / RS & 乖離率 / 成交量 / PEG 快算 / 🚧 either 遠離(上方)壓力 or 帶量突破壓力 / 💸 關鍵紅k與三盤沒跌破 應續抱", expanded=False):
